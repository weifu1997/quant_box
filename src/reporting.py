    ...
    lines.extend(
        [
            ...
            *_repair_action_lines(data_governance.get("repair_actions", [])),
            ...
            f"- Year coverage: {backtest_quality.get('year_count', 0)}/{backtest_quality.get('expected_year_count', 0)}",
            f"- Yearly annual return passes: {backtest_quality.get('year_ann_pass', 0)}/{backtest_quality.get('year_count', 0)}",
            f"- Yearly drawdown passes: {backtest_quality.get('year_dd_pass', 0)}/{backtest_quality.get('year_count', 0)}",
            f"- Min yearly annual return: {_pct(backtest_quality.get('min_year_annual_return'))}",
            f"- Worst yearly drawdown: {_pct(backtest_quality.get('worst_year_drawdown'))}",
