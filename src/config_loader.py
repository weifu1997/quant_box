...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "strategy": {
        ...
        "rebalance_after_risk_exit": False,
...
_CONFIG_VALIDATORS: dict[str, _Validator] = {
    ...
    "annual_state_router.moderate_positive_exposure": _number_between(0, 1),
    ...
    "annual_state_router.moderate_lower_source": _optional(_string_value),
    "annual_state_router.moderate_lower_ret252_min": _number_at_least(0),
    "annual_state_router.moderate_lower_ret252_max": _number_at_least(0),
    "annual_state_router.moderate_lower_exposure": _number_between(0, 1),
    ...
    "annual_state_router.risk_exit_min_positions": _optional(_int_at_least(1)),
    "annual_state_router.risk_exit_min_positions_reasons": _list_of_strings,
    ...
    "strategy.rebalance_after_risk_exit": _bool_value,
    ...
    "universe_builder.enabled": _bool_value,
    "universe_builder.require_file": _bool_value,
    "universe_builder.index_constituents_file": _string_value,
    "universe_builder.output_file": _string_value,
